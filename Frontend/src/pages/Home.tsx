  ...
  return (
    <div className="home-div">
      ...
      <h1 className="text-4xl	font-medium	">
        Welcome, <span className="text-lg	font-normal">{user.name}</span>
      </h1>

      <div className="mt-10" style={{display:"grid", gridTemplateColumns:"1fr 2fr"}}>
        <div>
